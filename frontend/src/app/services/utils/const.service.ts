...
export class ConstService {
  ...
  getAppComponentViewConstants() {
    return {
      ...
      saMail: ' En caso de fallas con la herramienta o solicitudes de acceso, contactar con: Herramientas Operativas | herramientasop.ve@telefonica.com | +58(424)233.16.26',
      web: ' Web: ',
